...
public:
    ...
    CString(unsigned int numb);			    //有参构造函数(无符号整型)
    CString(unsigned int numb, int outformat);	    //有参构造函数(无符号整型)
